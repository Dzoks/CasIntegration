package rs.dzoks.rest_application.model;
...
public class User {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, username, password, jmbg, fname, lname, male, birthDate, administrator, token, tokenExpirationTime);
    }
}
